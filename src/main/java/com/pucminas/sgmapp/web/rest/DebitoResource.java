...
/**
 * REST controller for managing {@link com.pucminas.sgmapp.domain.Debito}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DebitoResource {
     ...
     */
    @PostMapping("/debitos")
    public ResponseEntity<Debito> createDebito(@Valid @RequestBody Debito debito) throws URISyntaxException {
     ...
     */
    @PutMapping("/debitos")
    public ResponseEntity<Debito> updateDebito(@Valid @RequestBody Debito debito) throws URISyntaxException {
