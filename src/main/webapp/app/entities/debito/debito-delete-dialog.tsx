...
export const DebitoDeleteDialog = (props: IDebitoDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sgmApp.debito.delete.question">
        <Translate contentKey="sgmApp.debito.delete.question" interpolate={{ id: debitoEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-debito" color="danger" onClick={confirmDelete}>
